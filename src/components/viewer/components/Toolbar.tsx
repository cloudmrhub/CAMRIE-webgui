...
export default function Toolbar({
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
      {volumes[selectedVolume] !== undefined && (
        <Fragment>
          <Box
            sx={{
              display: 'flex',
          ...
          >
            <Box sx={{ display: 'flex', alignItems: 'center' }} m={1}>
              ...
              <Switch defaultChecked={false} checked={!radiological} onChange={toggleRadiological} />
            </Box>

            <Box sx={{ display: 'flex', alignItems: 'center' }} m={1}>
              <Typography sx={{ marginRight: 'auto' }}>Show Crosshair</Typography>
              <Switch defaultChecked={true} checked={showCrosshair} onChange={toggleShowCrosshair} />
            </Box>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center' }} m={1}>
              ...
              <Switch defaultChecked={false} checked={labelsVisible} onChange={toggleLabelsVisible} />
            </Box>
