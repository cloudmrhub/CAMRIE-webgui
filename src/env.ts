...
export const CLOUDMR_SERVER = import.meta.env.VITE_CLOUDMR_SERVER
 //'https://ewjjq013u0.execute-api.us-east-1.amazonaws.com';
...
export const API_TOKEN = import.meta.env.VITE_API_TOKEN || "iwAFDjSeeh9MvhpA7wCT92uztNtPV7NJ6Wwrnd9v";
